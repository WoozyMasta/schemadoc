...
schemadoc helps you build JSON Schema, docs, and example configs.
...
**Usage:** `schemadoc [OPTIONS] version [version-OPTIONS]`
...
```text
schemadoc mod2doc --template table --type Config github.com/acme/project@v1.2.3 docs/model.table.md
```

```text
schemadoc mod2doc --template html --description 'Generated by CI.' --type Config github.com/acme/project@v1.2.3 > model.html
```
...
```text
schemadoc schema2doc cat schema.json | --template table > schema.table.md
```

```text
schemadoc schema2doc --template html --description 'Generated by CI.' schema.json > schema.html
```
...
```text
schemadoc template --template table > table.gotmpl
```

```text
schemadoc template --template html > reference.html.gotmpl
```
...
- https://github.com/woozymasta/schemadoc
