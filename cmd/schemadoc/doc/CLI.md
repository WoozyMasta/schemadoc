...
- `schemadoc.exe build`
- `schemadoc.exe build schemadoc.build.yaml --index 1`
...
- `schemadoc.exe config > schemadoc.build.yaml`
- `schemadoc.exe config --mode required > schemadoc.build.min.yaml`
...
- `schemadoc.exe merge base.schema.json out.schema.json --merge-defs '/$defs=lint.schema.json#/$defs'`
- `schemadoc.exe merge --config schema-merge.yaml --inplace`
- `schemadoc.exe merge --config schema-merge.yaml --check`
...
- `schemadoc.exe mod2doc --type Config . > model.md`
- `schemadoc.exe mod2doc -t table --type Config github.com/acme/project@v1.2.3 docs/model.table.md`
- `schemadoc.exe mod2doc -t html --description "Generated by CI." --type Config github.com/acme/project@v1.2.3 > model.html`
- `schemadoc.exe mod2doc --mode required --format json --type Config github.com/acme/project@v1.2.3 > model.with-example.md`
- `schemadoc.exe mod2doc --type Config --key-namer snake . > model.snake.md`
...
- `schemadoc.exe mod2schema --type Config . > schema.json`
- `schemadoc.exe mod2schema --package github.com/acme/project/internal/config --type Config github.com/acme/project@v1.2.3 schema.json`
- `schemadoc.exe mod2schema --type Config --key-namer snake github.com/acme/project@latest > schema.snake.json`
...
- `schemadoc.exe schema2doc schema.json > schema.md`
- `cat schema.json | schemadoc.exe schema2doc -t table > schema.table.md`
- `schemadoc.exe schema2doc -t html --description "Generated by CI." schema.json > schema.html`
- `schemadoc.exe schema2doc --mode required --format yaml schema.json > schema.with-example.md`
...
- `schemadoc.exe schema2json schema.json > example.json`
- `schemadoc.exe schema2json --mode required schema.json example.required.json`
...
- `schemadoc.exe schema2yaml schema.json > example.yaml`
- `schemadoc.exe schema2yaml --mode all schema.json example.all.yaml`
...
- `schemadoc.exe template > list.gotmpl`
- `schemadoc.exe template -t table templates/table.gotmpl`
- `schemadoc.exe template -t html templates/reference.html.gotmpl`
