...
const (
	...
	defaultListMarker = "*"
	// defaultAutoGeneratedNote is the default note exposed to templates.
	defaultAutoGeneratedNote = "Generated by github.com/woozymasta/schemadoc ; do not edit this file directly."
)
...
func Render(schemaBytes []byte, opt Options) (string, error) {
	...
	markdownTemplate, metadata, err := resolveTemplate(opt)
	if err != nil {
		return "", err
	}
	...
	processed, err := applyTemplatePostProcessors(out.String(), metadata)
	if err != nil {
		return "", err
	}
